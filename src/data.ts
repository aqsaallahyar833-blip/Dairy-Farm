...
export const initialMilkRecords: MilkRecord[] = [
  { id: "M-101", animalId: "HF-027", name: "Bella", date: "2024-05-14", session: "Both", morningLitres: 14.5, eveningLitres: 14.2, totalLitres: 28.7, fatPercent: 3.8, proteinPercent: 3.25, snfPercent: 8.9, scc: 180, quality: "Premium", rejectedLitres: 10.0, rejectionReason: "Active withdrawal (Intramast)" },
  { id: "M-102", animalId: "HF-031", name: "Daisy", date: "2024-05-14", session: "Both", morningLitres: 13.8, eveningLitres: 13.6, totalLitres: 27.4, fatPercent: 3.7, proteinPercent: 3.22, snfPercent: 8.8, scc: 140, quality: "Premium" },
  { id: "M-103", animalId: "HF-014", name: "Molly", date: "2024-05-14", session: "Both", morningLitres: 13.1, eveningLitres: 13.0, totalLitres: 26.1, fatPercent: 3.9, proteinPercent: 3.30, snfPercent: 8.7, scc: 210, quality: "Standard" },
  { id: "M-104", animalId: "HF-021", name: "Lucy", date: "2024-05-14", session: "Both", morningLitres: 12.7, eveningLitres: 12.6, totalLitres: 25.3, fatPercent: 3.6, proteinPercent: 3.18, snfPercent: 8.6, scc: 190, quality: "Standard" },
  { id: "M-105", animalId: "HF-033", name: "Nora", date: "2024-05-14", session: "Both", morningLitres: 12.4, eveningLitres: 12.4, totalLitres: 24.8, fatPercent: 3.7, proteinPercent: 3.20, snfPercent: 8.7, scc: 165, quality: "Standard" },
  { id: "M-106", animalId: "HF-081", name: "Minnie", date: "2024-05-14", session: "Both", morningLitres: 10.2, eveningLitres: 10.0, totalLitres: 20.2, fatPercent: 3.8, proteinPercent: 3.24, snfPercent: 8.8, scc: 130, quality: "Standard" },
  // Previous days
  { id: "M-95", animalId: "HF-027", name: "Bella", date: "2024-05-13", session: "Both", morningLitres: 14.6, eveningLitres: 14.3, totalLitres: 28.9, fatPercent: 3.8, proteinPercent: 3.24, snfPercent: 8.9, quality: "Premium" },
  { id: "M-96", animalId: "HF-031", name: "Daisy", date: "2024-05-13", session: "Both", morningLitres: 13.7, eveningLitres: 13.5, totalLitres: 27.2, fatPercent: 3.7, proteinPercent: 3.20, snfPercent: 8.8, quality: "Premium" },
  { id: "M-97", animalId: "HF-014", name: "Molly", date: "2024-05-13", session: "Both", morningLitres: 13.0, eveningLitres: 12.9, totalLitres: 25.9, fatPercent: 3.9, proteinPercent: 3.29, snfPercent: 8.7, quality: "Standard" },
  { id: "M-98", animalId: "HF-021", name: "Lucy", date: "2024-05-13", session: "Both", morningLitres: 12.5, eveningLitres: 12.5, totalLitres: 25.0, fatPercent: 3.6, proteinPercent: 3.17, snfPercent: 8.6, quality: "Standard" },
  { id: "M-99", animalId: "HF-033", name: "Nora", date: "2024-05-13", session: "Both", morningLitres: 12.3, eveningLitres: 12.3, totalLitres: 24.6, fatPercent: 3.7, proteinPercent: 3.21, snfPercent: 8.7, quality: "Standard" },
];
